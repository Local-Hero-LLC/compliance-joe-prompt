...
| 7 | 5Q Home Prequal | first home-vertical variant, no legacy nickname | Roughly what year was the home built? / Single family house, condo, townhouse, or mobile home? / What kind of roof does it have? / About how old is the roof? / Who is the current home insurance company? | No. Opens: “Hi, this is Joe, on a recorded line.” then asks why they rang, or goes straight to question one if the caller already said they want a quote. | Mark | STUB VALIDATED, NOT DEPLOYED. No production home backend exists, so this cannot be deployed even if approved. | [+1 970-489-7865](tel:+19704897865) | [`5q_home_prequal.md`](5q_home_prequal.md) |  Nowhere in production. Test agent `fae9f397` has drifted from this file (33,355 chars vs 33,250). |

...
| 3 | 4Q Full Battery | "Compliance Joe", "Prequal + Compliance Joe" | What state are you calling from? / Are you currently insured? / Who's your current provider? / Insured 6+ months, no gaps? | **Yes. Exact wording: “How can I help you today?”** | Mark | LIVE since 2026-08-06. The provider-mapping correction is validated and awaiting Charlotte's backend test and deployment. | [+1 970-436-9313](tel:+19704369313) | [`4q_full_battery.md`](4q_full_battery.md) |  Nowhere. No Ultravox agent carries this file; Compliance-Joe-Prod now runs `5q_full_battery.md`. |
| 4 | 4Q Full Battery, Branded | "FQI Joe" | Same 4 questions; brand identity via `{{brandName}}` merge token (10 occurrences, nothing hardcoded) | **Yes. Exact wording: “How can I help you today?”** | Mark | LIVE-VERIFIED, low volume. Hash-identical to the deployed `prod_auto_compliance_fqi` agent template on 2026-08-27 (SHA-256 `68a366ee7259…`). Took 11 calls on 2026-08-20 and has been silent since. Provider-mapping correction added 2026-08-17; backend retest still required. | [+1 970-510-9982](tel:+19705109982) | [`4q_full_battery_branded.md`](4q_full_battery_branded.md) |  The three `*_auto_compliance_fqi` agents (prod `637e640f`). CtC ivr 17, 1 live campaign, 14 calls in 30d. |
| 5 | 2Q Transfer Handoff | "DL gate", "Data Lot handoff", "apologetic handoff" | Who are you currently insured with? (confirm) / Allstate-match accept? | No. Opens by acknowledging that the caller already answered questions. | Mark | ON HOLD per the 2026-08-08 decision. | [+1 970-648-8632](tel:+19706488632) | [`2q_transfer_handoff.md`](2q_transfer_handoff.md) |  Demo only. Agent DL-Gate-BEST-r9-20260808 (`c96eb3bc`); no CtC ivr, never took a production call. |
| 6 | 5Q Full Battery | "Compliance Joe + 3 questions", "the MDP-314 prompt" | And what state do you currently live in? / Are you currently insured? / Who's your current provider? / Insured 6+ months, no gaps? / Compliance advisory then say your state again | **Yes. Exact wording: “How can I help you today?”** | Charlotte | LIVE 2026-08-18. Charlotte's prompt-based first/second-state comparison dropped all 14 tested mismatches. Prod, Stage, and Dev are identical (SHA-256 `867010839e43…`). | [+1 970-512-3170](tel:+19705123170) | [`5q_full_battery.md`](5q_full_battery.md) |  Compliance-Joe-Prod (`33b95124`) only. CtC ivr 16 on +1 737-637-9256, 8 live campaigns, 2,194 calls in 30d. |
| 7 | 5Q Home Prequal | first home-vertical variant, no legacy nickname | Roughly what year was the home built? / Single family house, condo, townhouse, or mobile home? / What kind of roof does it have? / About how old is the roof? / Who is the current home insurance company? | No. Opens: “Hi, this is Joe, on a recorded line.” then asks why they rang, or goes straight to question one if the caller already said they want a quote. | Mark | STUB VALIDATED, NOT DEPLOYED. No production home backend exists, so this cannot be deployed even if approved. | [+1 970-489-7865](tel:+19704897865) | [`5q_home_prequal.md`](5q_home_prequal.md) |  Nowhere. The test agent `fae9f397` runs the later revision, row 10, not this file. |
| 8 | 2Q Commercial Intake | no legacy nickname; reached the team as "the Geico agent" after the ivr it serves | Is this referral to cover a trucking operation? (`is_trucking`) / And which state are you calling for? (`state`) | No. Opens: “Hi this is Joe, I just have a couple questions before I connect you with an agent.” | Charlotte | LIVE. Verified from a production call on 2026-08-26. | (none) | [`2q_commercial_intake.md`](2q_commercial_intake.md) |  CtC ivr 15 on +1 689-588-5693, 3 live campaigns, 91 calls in 30d. Ad-hoc call, no Ultravox agent id. |
| 9 | 5Q Full Battery, Hang-Up Reasons | "the CALLS-3509 prompt" | Same 5 questions; adds hang-up reason codes `state_mismatch`, `incentived_call`, `transfer_call`, `audio_quality`, `other` | **Yes. Exact wording: “How can I help you today?”** | Charlotte | STAGED, not in production. Stage and Dev are identical (SHA-256 `ac81a51c1541…`); prod still runs 5Q Full Battery. | (none) | [`5q_full_battery_hangup_reasons.md`](5q_full_battery_hangup_reasons.md) |  Compliance-Joe Stage/Dev (`0ae8e70b` / `e20e3520`). No CtC ivr, no production traffic. |
| 10 | 5Q Home Prequal, Short Repairs | no legacy nickname | Same 5 questions; shortens the three repair prompts and tightens the stage-direction rule | No. Same opener as 5Q Home Prequal. | Mark | DEPLOYED ON THE TEST AGENT ONLY, ahead of the repo. 33,355 chars (SHA-256 `117c1cde99ae…`) against 33,250 in `5q_home_prequal.md`; 7 diff hunks. | [+1 970-489-7865](tel:+19704897865) | [`5q_home_prequal_short_repairs.md`](5q_home_prequal_short_repairs.md) | Nowhere in production. Test agent TEST-JOE-07-5Q-HOME-20260819 (`fae9f397`) only. |
...
- `5q_full_battery.md`: the original 5Q candidate was derived from `4q_full_battery.md`; Charlotte owns the current deployed revision. On 2026-08-18 she added prompt-based comparison of the first and second spoken states, verified 14/14 mismatched-state calls were dropped, and deployed the identical prompt to Compliance-Joe Prod, Stage, and Dev. The repository file matches that live prompt byte-for-byte after newline normalization.
...
`5q_full_battery.md` was added on 2026-08-16 for MDP-314 / CALLS-3479. It does not replace `4q_full_battery.md`; the two are separate variants. The 4Q, branded 4Q, and 5Q files received the provider-mapping correction on 2026-08-17. On 2026-08-18 Charlotte replaced the unsupported `reconfirmedState` approach with the prompt-based state comparison now deployed to Prod, Stage, and Dev. The name follows the question count: the fifth ask is the compliance advisory and state re-confirmation.
